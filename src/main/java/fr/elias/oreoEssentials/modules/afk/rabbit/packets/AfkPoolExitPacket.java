...
public class AfkPoolExitPacket extends Packet {

    private UUID playerId;
    private BackLocation returnLocation;
    private String targetServer;

    public AfkPoolExitPacket() {
    }

    public AfkPoolExitPacket(UUID playerId, BackLocation returnLocation, String targetServer) {
