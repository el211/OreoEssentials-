...
/**
 * The OHologramsConfig class is responsible for managing the configuration of the OHolograms plugin.
 * It handles loading and saving hologram data, as well as providing access to various configuration settings.
 */
public final class OHologramsConfiguration implements HologramConfiguration {
    ...
    private void updateChecker(@NotNull OHolograms plugin, @NotNull FileConfiguration config) {
    ...
    @Override
    public synchronized void reload(@NotNull OHologramsPlugin plugin) {
        OHolograms pluginImpl = (OHolograms) plugin;
