package fr.elias.oreoEssentials.modules.holograms.util;
...
public enum Constants {
    ...
    public static final String FH_COMMAND_USAGE = "/OHolograms <save|reload|version|convert>";

    public static final String HELP_TEXT = """
            <%primary_color%><b>OHolograms commands help:<reset>
            ...
            <%primary_color%>- /hologram create <text|item|block> <name> <dark_gray>- <white>Creates a new hologram
