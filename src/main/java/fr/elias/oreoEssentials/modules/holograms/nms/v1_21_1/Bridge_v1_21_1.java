package fr.elias.oreoEssentials.modules.holograms.nms.v1_21_1;
...
public final class Bridge_v1_21_1 implements NmsHologramBridge {
    ...
    static {
        ...
        try {
            ...
            LOG.severe("[Bridge_v1_21_1] Static init failed: " + t);
        }
    ...
    public void sendTextDisplayText(Player player, int entityId, Component text) {
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21_1] sendTextDisplayText failed: " + t);
        }
    }
    ...
    public void destroyEntityClientside(Player player, int entityId) {
        try {
            ...
            LOG.warning("[Bridge_v1_21_1] destroyEntityClientside failed: " + t);
        }
    }
    ...
    public void teleportEntityClientside(Player player, int entityId,
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21_1] teleportEntityClientside failed: " + t);
        }
    }
