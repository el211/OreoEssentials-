package fr.elias.oreoEssentials.modules.holograms.nms.v1_21_8;
...
public final class Bridge_v1_21_8 implements NmsHologramBridge {
    ...
    static {
        ...
        try {
            ...
            LOG.severe("[Bridge_v1_21_8] Static init failed — per-player text will be unavailable: " + t);
        }
    ...
    public void sendTextDisplayText(Player player, int entityId, Component text) {
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21_8] sendTextDisplayText failed: " + t);
        }
    }
    ...
    public void destroyEntityClientside(Player player, int entityId) {
        try {
            ...
            LOG.warning("[Bridge_v1_21_8] destroyEntityClientside failed: " + t);
        }
    }
    ...
    public void teleportEntityClientside(Player player, int entityId,
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21_8] teleportEntityClientside failed: " + t);
        }
    }
    ...
    private static Field findField(Class<?> cls, String name) throws NoSuchFieldException {
        ...
        throw new NoSuchFieldException(name + " not found in class hierarchy of " + cls.getName());
    }
