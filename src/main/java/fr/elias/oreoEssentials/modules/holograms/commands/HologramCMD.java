...
import fr.elias.oreoEssentials.modules.holograms.commands.hologram.*;
...
public final class HologramCMD extends Command {
    ...
    public HologramCMD(@NotNull final OHolograms plugin) {
        super("hologram", "Main command for the OHolograms plugin", "/hologram help", List.of("holograms", "holo", "fholo"));
