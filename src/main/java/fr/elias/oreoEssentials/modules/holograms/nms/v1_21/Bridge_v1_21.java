package fr.elias.oreoEssentials.modules.holograms.nms.v1_21;
...
/**
 * NMS bridge for Minecraft v1_21 (Paper).
 * Pure reflection — no net.minecraft.* imports, compiles against standard Paper API only.
 */
public final class Bridge_v1_21 implements NmsHologramBridge {
    ...
    static {
        ...
        try {
            ...
            LOG.severe("[Bridge_v1_21] Static init failed: " + t);
        }
    ...
    public void sendTextDisplayText(Player player, int entityId, Component text) {
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21] sendTextDisplayText failed: " + t);
        }
    }
    ...
    public void destroyEntityClientside(Player player, int entityId) {
        try {
            ...
            LOG.warning("[Bridge_v1_21] destroyEntityClientside failed: " + t);
        }
    }
    ...
    public void teleportEntityClientside(Player player, int entityId,
        ...
        try {
            ...
            LOG.warning("[Bridge_v1_21] teleportEntityClientside failed: " + t);
        }
    }
