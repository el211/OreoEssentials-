package fr.elias.oreoEssentials.modules.holograms.api.data;
...
public class HologramData implements YamlData {
    ...
    public int getVisibilityDistance() {
        ...
        return OHologramsPlugin.get().getHologramConfiguration().getDefaultVisibilityDistance();
    }
    ...
    public boolean read(ConfigurationSection section, String name) {
        ...
        if (world == null) {
            OHologramsPlugin.get().getFancyLogger().warn("Could not load hologram '" + name + "', because the world '" + worldName + "' is not loaded");
            return false;
        }
