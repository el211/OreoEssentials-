package fr.elias.oreoEssentials.modules.holograms.api.data.property;
...
public enum Visibility {
     ...
     */
    PERMISSION_REQUIRED(
        (player, hologram) -> player.hasPermission("OHolograms.viewhologram." + hologram.getData().getName())
    ),
    /**
