...
import fr.elias.oreoEssentials.modules.holograms.util.NumberHelper;
...
public class NearbyCMD implements Subcommand {
    ...
    public boolean run(@NotNull CommandSender player, @Nullable Hologram hologram, @NotNull String[] args) {
        ...
        if (!(player.hasPermission("OHolograms.hologram.nearby"))) {
        ...
        List<Map.Entry<Hologram, Double>> nearby = OHolograms.get()
            .getHologramsManager()
