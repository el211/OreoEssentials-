package fr.elias.oreoEssentials.currency;
...
public class CurrencyService {
    ...
    public CompletableFuture<Double> getBalance(UUID playerId, String currencyId) {
        ...
        return storage.loadBalance(playerId, currencyId).thenApply(balance -> {
    ...
    private void broadcastCurrencySync(Currency currency, boolean isCreate) {
        try {
            ...
            fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket packet;

            if (isCreate) {
                packet = new fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket(
                        fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket.Action.CREATE,
                        currency.getId(),
                        currency.getName(),
                        currency.getSymbol(),
                ...
                packet = new fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket(
                        fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket.Action.DELETE,
                        currency.getId()
                );
            }
     ...
     */
    public void handleCurrencySync(fr.elias.oreoEssentials.currency.rabbitmq.CurrencySyncPacket packet) {
        if (packet == null) {
