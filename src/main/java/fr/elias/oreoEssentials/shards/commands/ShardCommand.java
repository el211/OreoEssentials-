package fr.elias.oreoEssentials.shards.commands;
...
public class ShardCommand implements CommandExecutor, TabCompleter {
    ...
    /**
     * /shard test <worldname> - Test if you're in the right shard
     * Shows which shard you should be on vs which you're actually on
     */
