// File: src/main/java/fr/elias/oreoEssentials/holograms/perplayer_nms/PerPlayerTextDisplayListener.java
...
public final class PerPlayerTextDisplayListener implements Listener {
    ...
    private void cleanup(Player p) {
        service.cleanupPlayer(p); // why: prevent stale per-player overrides
    }
}
